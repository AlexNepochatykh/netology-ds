-- Creating 4 tables for the final test
-- As an example the Microsift Northwind sample database has been taken.
-- It was tailored to the netology task (having only 4 connected tables)
